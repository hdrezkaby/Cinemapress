module.exports = {
    ...
    "social": {
        "status": false,
        "data": {
            "vk": "https://github.com/hdrezkaby/CinemaPress",
    ...
    "player": {
        ...
        "data": {
            ...
            "custom": [
                "https://apivb.info/api/videos.json?token=d16fe09ddd4d031b06a32a2e535147fc&id_kp=[kp_id]&d=hdrezka.by ~ \"HDVB\" ~ 0.iframe_url <> _VALUE_?season=[season]&episode=[episode]",
                "https://api.bhcesh.me/list?token=4c250f7ac0a8c8a658c789186b9a58a5&kinopoisk_id=[kp_id] ~ \"Collaps\" ~ results.0.iframe_url <> _VALUE_?season=[season]&episode=[episode]",
                "https://videocdn.tv/api/short?api_token=Gbpr6CeRcQKypJK0J8MxvXgxavuPMV86&kinopoisk_id=[kp_id] ~ \"VideoCDN\" ~ data.0.iframe_src <> _VALUE_?season=[season]&episode=[episode]",
                "https://kodikapi.com/search?token=41dd95f84c21719b09d6c71182237a25&kinopoisk_id=[kp_id] ~ \"Kodik\" ~ results.0.link <> _VALUE_?season=[season]&episode=[episode]",
                "https://api.alloha.tv/?token=de19b0b4e75ce15a9be8e63c0f5858&kp=[kp_id] ~ \"Alloha\" ~ data.iframe <> _VALUE_?season=[season]&episode=[episode]",
                "https://iframe.video/api/v2/search?kp=[kp_id] ~ \"iframe.video\" ~ results.0.path <> _VALUE_?season=[season]&episode=[episode]",
        ...
        "data": {
            ...
            "index": {
                ...
                "custom": [
                    ...
                    "https://api.bhcesh.me/list?token=4c250f7ac0a8c8a658c789186b9a58a5&type=serials ~ results.0.kinopoisk_id ~ results.0.seasons.0.season ~ results.0.seasons.0.episodes.0.episode"
                ]
            },
            "custom": [
                ...
                "https://api.bhcesh.me/franchise/details?token=4c250f7ac0a8c8a658c789186b9a58a5&kinopoisk_id=[kp_id] ~ seasons.0.season ~ seasons.0.episodes.0.episode ~ seasons.0.episodes.0.voiceActing.0"
            ],
            "translations": ""
        }
    },
