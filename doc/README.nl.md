...
![NL](https://raw.githubusercontent.com/CinemaPress/CinemaPress/master/themes/default/public/admin/images/min/locales/nl.svg?sanitize=true)
...
![Installeren via terminal](https://raw.githubusercontent.com/CinemaPress/CinemaPress/master/themes/default/public/admin/images/min/cli.png)
...
···· | **[KIEZEN](https://cinemapressio.github.io/ref/ua-hosting.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/inferno.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/pq.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/zomro.html)**
...
···· | **[KIEZEN](https://cinemapressio.github.io/ref/tonic.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/internetbs.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/pananames.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/namecheap.html)**

> `*` - gegevens worden niet verzonden naar de openbare WHOIS-database

## Waar kan ik een VPN kopen?
...
···· | **[KIEZEN](https://cinemapressio.github.io/ref/surfshark.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/cyberghost.html)** | **[KIEZEN](https://cinemapressio.github.io/ref/purevpn.html)**

## Thema «hodor»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Hodor/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Hodor/) / [BitBucket](https://bitbucket.org/cinemapress/theme-hodor/)

> Installeren via CLI: `cinemapress theme example.com hodor`

> **DEMO:** `«hodor»`

[![Sjabloon «hodor»](https://raw.githubusercontent.com/CinemaPress/Theme-Hodor/master/screenshot.png)](https://github.com/CinemaPress/Theme-Hodor/)

## Thema «sansa»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Sansa/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Sansa/) / [BitBucket](https://bitbucket.org/cinemapress/theme-sansa/)

> Installeren via CLI: `cinemapress theme example.com sansa`

> **DEMO:** `«sansa»`

[![Sjabloon «sansa»](https://raw.githubusercontent.com/CinemaPress/Theme-Sansa/master/screenshot.png)](https://github.com/CinemaPress/Theme-Sansa/)

## Thema «robb»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Robb/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Robb/) / [BitBucket](https://bitbucket.org/cinemapress/theme-robb/)

> Installeren via CLI: `cinemapress theme example.com robb`

> **DEMO:** `«robb»`

[![Sjabloon «robb»](https://raw.githubusercontent.com/CinemaPress/Theme-Robb/master/screenshot.png)](https://github.com/CinemaPress/Theme-Robb/)

## Thema «ramsay»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Ramsay/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Ramsay/) / [BitBucket](https://bitbucket.org/cinemapress/theme-ramsay/)

> Installeren via CLI: `cinemapress theme example.com ramsay`

> **DEMO:** `«ramsay»`

[![Sjabloon «ramsay»](https://raw.githubusercontent.com/CinemaPress/Theme-Ramsay/master/screenshot.png)](https://github.com/CinemaPress/Theme-Ramsay/)

## Thema «tyrion»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Tyrion/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Tyrion/) / [BitBucket](https://bitbucket.org/cinemapress/theme-tyrion/)

> Installeren via CLI: `cinemapress theme example.com tyrion`

> **DEMO:** `«tyrion»`

[![Sjabloon «tyrion»](https://raw.githubusercontent.com/CinemaPress/Theme-Tyrion/master/screenshot.png)](https://github.com/CinemaPress/Theme-Tyrion/)

## Thema «cersei»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Cersei/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Cersei/) / [BitBucket](https://bitbucket.org/cinemapress/theme-cersei/)

> Installeren via CLI: `cinemapress theme example.com cersei`

> **DEMO:** `«cersei»`

[![Sjabloon «cersei»](https://raw.githubusercontent.com/CinemaPress/Theme-Cersei/master/screenshot.png)](https://github.com/CinemaPress/Theme-Cersei/)

## Thema «joffrey»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Joffrey/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Joffrey/) / [BitBucket](https://bitbucket.org/cinemapress/theme-joffrey/)

> Installeren via CLI: `cinemapress theme example.com joffrey`

> **DEMO:** `«joffrey»`

[![Sjabloon «joffrey»](https://raw.githubusercontent.com/CinemaPress/Theme-Joffrey/master/screenshot.png)](https://github.com/CinemaPress/Theme-Joffrey/)

## Thema «drogo»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Drogo/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Drogo/) / [BitBucket](https://bitbucket.org/cinemapress/theme-drogo/)

> Installeren via CLI: `cinemapress theme example.com drogo`

> **DEMO:** `«drogo»`

[![Sjabloon «drogo»](https://raw.githubusercontent.com/CinemaPress/Theme-Drogo/master/screenshot.png)](https://github.com/CinemaPress/Theme-Drogo/)

## Thema «bran»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Bran/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Bran/) / [BitBucket](https://bitbucket.org/cinemapress/theme-bran/)

> Installeren via CLI: `cinemapress theme example.com bran`

> **DEMO:** `«bran»`

[![Sjabloon «bran»](https://raw.githubusercontent.com/CinemaPress/Theme-Bran/master/screenshot.png)](https://github.com/CinemaPress/Theme-Bran/)

## Thema «arya»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Arya/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Arya/) / [BitBucket](https://bitbucket.org/cinemapress/theme-arya/)

> Installeren via CLI: `cinemapress theme example.com arya`

> **DEMO:** `«arya»`

[![Sjabloon «arya»](https://raw.githubusercontent.com/CinemaPress/Theme-Arya/master/screenshot.png)](https://github.com/CinemaPress/Theme-Arya/)

## Thema «mormont»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Mormont/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Mormont/) / [BitBucket](https://bitbucket.org/cinemapress/theme-mormont/)

> Installeren via CLI: `cinemapress theme example.com mormont`

> **DEMO:** `«mormont»`

[![Sjabloon «mormont»](https://raw.githubusercontent.com/CinemaPress/Theme-Mormont/master/screenshot.png)](https://github.com/CinemaPress/Theme-Mormont/)

## Thema «tarly»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Tarly/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Tarly/) / [BitBucket](https://bitbucket.org/cinemapress/theme-tarly/)

> Installeren via CLI: `cinemapress theme example.com tarly`

> **DEMO:** `«tarly»`

[![Sjabloon «tarly»](https://raw.githubusercontent.com/CinemaPress/Theme-Tarly/master/screenshot.png)](https://github.com/CinemaPress/Theme-Tarly/)

## Thema «daenerys»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Daenerys/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Daenerys/) / [BitBucket](https://bitbucket.org/cinemapress/theme-daenerys/)

> Installeren via CLI: `cinemapress theme example.com daenerys`

> **DEMO:** `«daenerys»`

[![Sjabloon «daenerys»](https://raw.githubusercontent.com/CinemaPress/Theme-Daenerys/master/screenshot.png)](https://github.com/CinemaPress/Theme-Daenerys/)

## Thema «tormund»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Tormund/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Tormund/) / [BitBucket](https://bitbucket.org/cinemapress/theme-tormund/)

> Installeren via CLI: `cinemapress theme example.com tormund`

> **DEMO:** `«tormund»`

[![Sjabloon «tormund»](https://raw.githubusercontent.com/CinemaPress/Theme-Tormund/master/screenshot.png)](https://github.com/CinemaPress/Theme-Tormund/)

## Thema «snow»

> Installeren via FTP: [GitHub](https://github.com/CinemaPress/Theme-Snow/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Snow/) / [BitBucket](https://bitbucket.org/cinemapress/theme-snow/)

> Installeren via CLI: `cinemapress theme example.com snow`

> **DEMO:** `«snow»`

[![Sjabloon «snow»](https://raw.githubusercontent.com/CinemaPress/Theme-Snow/master/screenshot.png)](https://github.com/CinemaPress/Theme-Snow/)
