...
> Operativsystemet ska vara **Debian, CentOS, Fedora, Ubuntu (Latest Stable Version)** utan kontrollpaneler!
...
> Installera via FTP: [GitHub](https://github.com/CinemaPress/Theme-Tormund/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Tormund/) / [BitBucket](https://bitbucket.org/cinemapress/theme-tormund/)

> Installera via CLI: `cinemapress theme example.com tormund`
...
> Installera via FTP: [GitHub](https://github.com/CinemaPress/Theme-Snow/) / [GitLab](https://gitlab.com/CinemaPress/Theme-Snow/) / [BitBucket](https://bitbucket.org/cinemapress/theme-snow/)

> Installera via CLI: `cinemapress theme example.com snow`
